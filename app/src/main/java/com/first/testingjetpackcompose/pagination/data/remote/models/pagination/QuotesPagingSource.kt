package com.first.testingjetpackcompose.pagination.data.remote.models.pagination
...
import com.first.testingjetpackcompose.pagination.data.remote.models.toQuotes
...
class QuotesPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Quotes> {
        ...
        return try{
            ...
            val nextKey = if(quotes.data.isEmpty()) null
            else quotes.pagination.nextPage

            LoadResult.Page(

                data = quotes.data.map{
                    it.toQuotes(quotes.pagination.currentPage)
                },
